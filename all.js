...
function jsOutput_HTML(dataFile) {
    console.log(`function jsOutput_HTML(${dataFile})`);
    ...
    if(dataFile == 'personal') musicDOM.src = `audio/001.mp3`;
    if(dataFile == 'studio') musicDOM.src = `audio/002.mp3`;
    if(dataFile == 'team') musicDOM.src = `audio/003.mp3`;
...
function refreshCardSliderState() {
    console.log('function refreshCardSliderState');
...
function initCardSliderEvents() {
    console.log('function initCardSliderEvents');
...
function updatePhotoAndThumb(borders, thumbList, photo, thumbWidth) {
    console.log(`function updatePhotoAndThumb(${borders}, ${thumbList}, ${photo}, ${thumbWidth})`);
...
function moveThumbList(direction, thumbList, thumbWidth) {
    console.log(`function moveThumbList(${direction}, ${thumbList}, ${thumbWidth})`);
...
function scrollThumbIntoView(target, thumbList, thumbWidth) {
    console.log(`function scrollThumbIntoView(${target}, ${thumbList}, ${thumbWidth})`);
